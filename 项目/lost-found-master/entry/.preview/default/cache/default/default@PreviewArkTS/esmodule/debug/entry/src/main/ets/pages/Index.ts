...
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(95:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 内容区域
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(105:7)", "entry");
            // 内容区域
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 欢迎区域
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(107:9)", "entry");
            // 欢迎区域
            Column.margin({ top: 40, bottom: 40 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('📱');
            Text.debugLine("entry/src/main/ets/pages/Index.ets(108:11)", "entry");
            Text.fontSize(64);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('欢迎使用');
            Text.debugLine("entry/src/main/ets/pages/Index.ets(113:11)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/Index.ets(119:11)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 用户名输入
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(128:11)", "entry");
            // 用户名输入
            Column.width('100%');
            // 用户名输入
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/Index.ets(136:13)", "entry");
            TextInput.width('100%');
            TextInput.height(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/Index.ets(169:13)", "entry");
            TextInput.width('100%');
            TextInput.height(48);
            TextInput.fontSize(16);
            TextInput.borderRadius(8);
            ...
            if (this.errorMessage) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/Index.ets(196:13)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#ff4444');
                        Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(205:11)", "entry");
            // 登录按钮
            Button.width('100%');
            // 登录按钮
            Button.height(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/Index.ets(222:11)", "entry");
            // 注册按钮
            Button.width('100%');
            // 注册按钮
            Button.height(48);
