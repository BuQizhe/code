...
export class GradientButton extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/components/CommonComponents.ets(43:5)", "entry");
...
export class CustomTextInput extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/CommonComponents.ets(72:5)", "entry");
            Column.width('100%');
            ...
            if (this.label) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(74:9)", "entry");
                        Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/components/CommonComponents.ets(81:7)", "entry");
            TextInput.width('100%');
            TextInput.height(48);
            ...
            if (this.errorMessage) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(95:9)", "entry");
                        Text.fontSize(14);
...
export class CardContainer extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/CommonComponents.ets(118:5)", "entry");
            Column.width('100%');
...
export class StatusTag extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(179:5)", "entry");
...
export class EmptyState extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/CommonComponents.ets(198:5)", "entry");
            Column.width('100%');
            Column.padding(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(199:7)", "entry");
            Text.fontSize(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(203:7)", "entry");
            Text.fontSize(18);
            ...
            if (this.description) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(210:9)", "entry");
                        Text.fontSize(14);
            ...
            if (this.actionText && this.onAction) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/components/CommonComponents.ets(218:9)", "entry");
                        Button.height(40);
                        Button.fontSize(14);
...
export class LoadingSpinner extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/CommonComponents.ets(246:5)", "entry");
            Column.justifyContent(FlexAlign.Center);
            Column.alignItems(HorizontalAlign.Center);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            LoadingProgress.create();
            LoadingProgress.debugLine("entry/src/main/ets/components/CommonComponents.ets(247:7)", "entry");
            ...
            if (this.text) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(253:9)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#666666');
                        Text.margin({ top: 10 });
                    }, Text);
...
export class HeaderBar extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/CommonComponents.ets(275:5)", "entry");
            Row.width('100%');
            Row.height(60);
            Row.linearGradient({
                angle: 135,
            ...
            if (this.showBack) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/components/CommonComponents.ets(277:9)", "entry");
                        Button.fontSize(20);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/components/CommonComponents.ets(289:9)", "entry");
                        Row.width(40);
                    }, Row);
                    Row.pop();
                });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.title);
            Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(292:7)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.showAction && this.actionText) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithLabel(this.actionText);
                        Button.debugLine("entry/src/main/ets/components/CommonComponents.ets(300:9)", "entry");
                        Button.fontSize(16);
                        Button.fontColor(Color.White);
                        Button.backgroundColor(Color.Transparent);
                        Button.onClick(() => {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/components/CommonComponents.ets(310:9)", "entry");
                        Row.width(40);
                    }, Row);
                    Row.pop();
                });
...
export class BottomTabBar extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/CommonComponents.ets(348:5)", "entry");
            Row.width('100%');
            Row.height(70);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/components/CommonComponents.ets(350:9)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(351:11)", "entry");
                    Text.fontSize(20);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(355:11)", "entry");
                    Text.fontSize(12);
                    Text.fontColor(index === this.currentIndex ? '#667eea' : '#999999');
                    Text.margin({ top: 4 });
                }, Text);
...
export class ImageUploader extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("entry/src/main/ets/components/CommonComponents.ets(389:5)", "entry");
            Flex.width('100%');
        }, Flex);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 已选择的图片
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Stack.create();
                    Stack.debugLine("entry/src/main/ets/components/CommonComponents.ets(392:9)", "entry");
                    Stack.margin({ right: 10, bottom: 10 });
                }, Stack);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/components/CommonComponents.ets(393:11)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('🖼️');
                    Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(400:11)", "entry");
                    Text.fontSize(24);
                    Text.fontColor('#999999');
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // 删除按钮
                    Text.create('×');
                    Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(405:11)", "entry");
                    // 删除按钮
                    Text.fontSize(16);
                    // 删除按钮
                    Text.fontColor(Color.White);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.selectedImages.length < this.maxCount) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Stack.create();
                        Stack.debugLine("entry/src/main/ets/components/CommonComponents.ets(426:9)", "entry");
                        Stack.onClick(() => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/components/CommonComponents.ets(427:11)", "entry");
                        Column.width(this.imageSize);
                        Column.height(this.imageSize);
                        Column.borderRadius(8);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/components/CommonComponents.ets(434:11)", "entry");
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('📷');
                        Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(435:13)", "entry");
                        Text.fontSize(20);
                        Text.fontColor('#999999');
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('添加');
                        Text.debugLine("entry/src/main/ets/components/CommonComponents.ets(438:13)", "entry");
                        Text.fontSize(12);
                        Text.fontColor('#999999');
                        Text.margin({ top: 4 });
                    }, Text);
