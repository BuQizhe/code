...
class MessagePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/MessagePage.ets(163:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 内容区域
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/MessagePage.ets(177:7)", "entry");
            // 内容区域
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 筛选标签
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MessagePage.ets(179:9)", "entry");
            // 筛选标签
            Row.width('100%');
            // 筛选标签
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(tab);
                    Text.debugLine("entry/src/main/ets/pages/MessagePage.ets(181:13)", "entry");
                    Text.fontSize(14);
            ...
            if (this.isLoading && this.messages.length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 加载状态
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/MessagePage.ets(206:11)", "entry");
                        // 加载状态
                        Column.width('100%');
                        // 加载状态
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('加载中...');
                        Text.debugLine("entry/src/main/ets/pages/MessagePage.ets(207:13)", "entry");
                        Text.fontSize(16);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 空状态
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/MessagePage.ets(216:11)", "entry");
                        // 空状态
                        Column.width('100%');
                        // 空状态
                        Column.justifyContent(FlexAlign.Center);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('暂无消息');
                        Text.debugLine("entry/src/main/ets/pages/MessagePage.ets(217:13)", "entry");
                        Text.fontSize(16);
                        Text.fontColor('#999999');
                        Text.margin({ top: 50 });
                    }, Text);
                ...
                this.ifElseBranchUpdateFunction(2, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        List.create();
                        List.debugLine("entry/src/main/ets/pages/MessagePage.ets(225:11)", "entry");
                        List.width('100%');
                        List.height('100%');
                        List.layoutWeight(1);
                        ...
                        const forEachItemGenFunction = _item => {
                            const message = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.debugLine("entry/src/main/ets/pages/MessagePage.ets(227:13)", "entry");
                                };
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    itemCreation(elmtId, isInitialRender);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create();
                                        Row.debugLine("entry/src/main/ets/pages/MessagePage.ets(228:15)", "entry");
                                        Row.width('100%');
                                        Row.padding(16);
                                        ...
                                        if (message.avatar === '🔔') {
                                            this.ifElseBranchUpdateFunction(0, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    ...
                                                    Text.debugLine("entry/src/main/ets/pages/MessagePage.ets(231:19)", "entry");
                                                    Text.fontSize(20);
                                                    Text.width(40);
                                                    Text.height(40);
                                            ...
                                            this.ifElseBranchUpdateFunction(1, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Text.create(message.avatar);
                                                    Text.debugLine("entry/src/main/ets/pages/MessagePage.ets(241:19)", "entry");
                                                    Text.fontSize(16);
                                                    Text.fontColor(Color.White);
                                                    Text.width(40);
                                                    Text.height(40);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        // 消息内容
                                        Column.create();
                                        Column.debugLine("entry/src/main/ets/pages/MessagePage.ets(253:17)", "entry");
                                        // 消息内容
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/MessagePage.ets(254:19)", "entry");
                                        Text.fontSize(16);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/MessagePage.ets(261:19)", "entry");
                                        Text.fontSize(14);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        // 右侧时间和未读标识
                                        Column.create();
                                        Column.debugLine("entry/src/main/ets/pages/MessagePage.ets(272:17)", "entry");
                                        // 右侧时间和未读标识
                                        Column.alignItems(HorizontalAlign.End);
                                    }, Column);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(message.time);
                                        Text.debugLine("entry/src/main/ets/pages/MessagePage.ets(273:19)", "entry");
                                        Text.fontSize(12);
                                        Text.fontColor('#999999');
                                        ...
                                        if (message.unreadCount && message.unreadCount > 0) {
                                            this.ifElseBranchUpdateFunction(0, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    ...
                                                    Text.debugLine("entry/src/main/ets/pages/MessagePage.ets(279:21)", "entry");
                                                    Text.fontSize(12);
                                                    Text.fontColor(Color.White);
